...
- then install the JSON server with `npm install json-server@0.17.4` command
...
- then create a github repo and push this code there
- then host it at {++ render ++} by connecting your github to render
- `https://dashboard.render.com/`

- then you will get an api link something like this
