...
> See also: *Working with Third-Party Libraries* introduces typing API clients
> like `axios` and `fetch`. This chapter expands on that with error handling,
> generics, and runtime validation.
